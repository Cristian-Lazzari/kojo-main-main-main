        ...
        <div class="menu-top">
          ...
          <div class="menu-top-right">
            ...
            <div class="categorie"   :class="catinput ? 'cat-on': 'cat-off'">
              <div v-for="(cat, i) in arrCategory" class="category" :class="actvcat == cat.id ? 'category-on' : '' , i == 0 ? 'category0' : '',i == 1 ? 'category1' : '', i == 2 ? 'category2' : '',i == 3 ? 'category3' : '',i == 4 ? 'category4' : '',i == 5 ? 'category5' : '' " @click="changeCategory(cat.id)" :key="i"> 
